...
export function PixPaymentDialog({
  ...
  }, [hasPayment, matchName, message, open, totalCents, transactionId]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#0B0E14] border border-[#2D3A52] w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] max-h-[calc(100vh-2rem)] overflow-y-auto">
        <DialogHeader>
        ...
        <div className={`grid gap-4 ${hasPayment ? 'md:grid-cols-[180px,1fr]' : ''}`}>
          {hasPayment ? (
            <div className="rounded-lg border border-[#2D3A52] bg-[#0F1729] p-3 pt-9! flex flex-col items-center gap-3">
