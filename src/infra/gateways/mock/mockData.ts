...
const playersSeed = {
  ...
  '5': { id: '5', name: 'Ana Paula Ribeiro', nickname: 'Ana "Viper" Ribeiro', reportCount: 5, praiseCount: 8, history: [] },
  '6': { id: '6', name: 'Rafael Souza Mendes', nickname: 'Rafael "Hawk" Souza', reportCount: 8, praiseCount: 10, history: [] },
  '7': { id: '7', name: 'Fernanda Lima Santos', nickname: 'Fernanda "Phoenix" Lima', reportCount: 2, praiseCount: 18, history: [] },
  '8': { id: '8', name: 'Lucas Pereira Costa', nickname: 'Lucas "Wolf" Pereira', reportCount: 11, praiseCount: 5, history: [] },
  '9': { id: '9', name: 'Juliana Costa Alves', nickname: 'Juliana "Falcon" Costa', reportCount: 3, praiseCount: 14, history: [] },
  '10': { id: '10', name: 'Bruno Santos Rocha', nickname: 'Bruno "Tiger" Santos', reportCount: 9, praiseCount: 7, history: [] },
  '11': { id: '11', name: 'Camila Rodrigues Silva', nickname: 'Camila "Raven" Rodrigues', reportCount: 0, praiseCount: 25, history: [] },
  '12': { id: '12', name: 'Diego Martins Ferreira', nickname: 'Diego "Snake" Martins', reportCount: 18, praiseCount: 2, history: [] },
};
