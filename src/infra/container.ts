...
if (backend === 'supabase') {
  ...
  container.register(TkNotificationGateway, { useClass: SupabaseNotificationGateway });
  ...
  container.register(TkNotificationGateway, { useClass: MockNotificationGateway });
}
